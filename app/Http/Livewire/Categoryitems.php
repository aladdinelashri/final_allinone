...
class Categoryitems extends Component
{
    ...
    {
        $this->validate();
        Categoryitem::create($this->modelData());
    ...
    {
        return Categoryitem::paginate(5);
    }
    ...
    {
        $this->validate();
        Categoryitem::find($this->modelId)->update($this->modelData());
        $this->modalFormVisible = false;
    ...
    {
        Categoryitem::destroy($this->modelId);
    ...
    {
        $data = Categoryitem::find($this->modelId);
        $this->name = $data->name;
    ...
    {
        return view('livewire.Categoryitems', [
            'data' => $this->read(),
        ]);
    }
}
