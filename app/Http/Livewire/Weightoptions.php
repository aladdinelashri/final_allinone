...
class Weightoptions extends Component
{
    ...
    {
        $this->validate();
        Weightoption::create($this->modelData());
    ...
    {
        return Weightoption::paginate(5);
    }
    ...
    {
        $this->validate();
        Weightoption::find($this->modelId)->update($this->modelData());
        $this->modalFormVisible = false;
    ...
    {
        Weightoption::destroy($this->modelId);
    ...
    {
        return view('livewire.Weightoptions', [
            'data' => $this->read(),
        ]);
    }
}
