...
class Sdelcategoryitems extends Component
{
    use WithPagination;
    ...
    {
        $this->validate();
        Categoryitem::create($this->modeldata2());
    ...
    {
        return Categoryitem::onlyTrashed()->paginate(5);
    }
    /**
     * The update function.
     *
    ...
    {
        $this->validate();
        Categoryitem::find($this->modelId2)->update($this->modeldata2());
        $this->modal2FormVisible = false;
        $this->dispatchBrowserEvent('event-notification', [
    ...
    {
        Categoryitem::onlyTrashed()->find($this->modelId2)->forceDelete($this->modeldata2());
    ...
    {
        Categoryitem::withTrashed()->find($this->modelId2)->restore();
    ...
    {
        return view('livewire.sdelcategoryitems', [
            'data2' => $this->read(),
        ]);
    }
}
