...
class Sdeltagitems extends Component
{
    use WithPagination;
    ...
    {
        $this->validate();
        Tagitem::create($this->modeldata2());
    ...
    {
        return Tagitem::onlyTrashed()->paginate(5);
    }
    /**
     * The update function.
     *
    ...
    {
        $this->validate();
        Tagitem::find($this->modelId2)->update($this->modeldata2());
        $this->modal2FormVisible = false;
        $this->dispatchBrowserEvent('event-notification', [
    ...
    {
        Tagitem::onlyTrashed()->find($this->modelId2)->forceDelete($this->modeldata2());
    ...
    {
        Tagitem::withTrashed()->find($this->modelId2)->restore();
    ...
    {
        $data2 = Tagitem::withTrashed()->find($this->modelId2);
    ...
    {
        return view('livewire.sdeltagitems', [
            'data2' => $this->read(),
        ]);
    }
}
