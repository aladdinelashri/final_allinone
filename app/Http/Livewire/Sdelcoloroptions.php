...
class Sdelcoloroptions extends Component
{
    ...
    {
        $this->validate();
        Coloroption::create($this->modeldata2());
    ...
    {
        return Coloroption::onlyTrashed()->paginate(5);
    }
    /**
     * The update function.
     *
    ...
    {
        $this->validate();
        Coloroption::find($this->modelId2)->update($this->modeldata2());
        $this->modal2FormVisible = false;
        $this->dispatchBrowserEvent('event-notification', [
    ...
    {
        Coloroption::onlyTrashed()->find($this->modelId2)->forceDelete($this->modeldata2());
    ...
    {
        Coloroption::withTrashed()->find($this->modelId2)->restore();
    ...
    {
        $data2 = Coloroption::withTrashed()->find($this->modelId2);
    ...
    {
        return view('livewire.sdelcoloroptions', [
            'data2' => $this->read(),
        ]);
    }
}
