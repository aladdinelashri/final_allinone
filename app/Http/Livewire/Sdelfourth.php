...
class Sdelfourth extends Component
{
    use WithPagination;
    ...
    {
        $this->validate();
        Fourthoption::create($this->modeldata2());
    ...
    {
        return Fourthoption::onlyTrashed()->paginate(5);
    }
    /**
     * The update function.
     *
    ...
    {
        $this->validate();
        Fourthoption::find($this->modelId2)->update($this->modeldata2());
        $this->modal2FormVisible = false;
        $this->dispatchBrowserEvent('event-notification', [
    ...
    {
        Fourthoption::onlyTrashed()->find($this->modelId2)->forceDelete($this->modeldata2());
    ...
    {
        Fourthoption::withTrashed()->find($this->modelId2)->restore();
    ...
    {
        $data2 = Fourthoption::withTrashed()->find($this->modelId2);
        $this->name = $data->name;
        $this->note = $data->note;
    ...
    {
        return view('livewire.sdelfourth', [
            'data2' => $this->read(),
        ]);
    }
}
