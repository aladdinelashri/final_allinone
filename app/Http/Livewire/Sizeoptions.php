...
class Sizeoptions extends Component
{
    ...
    {
        $this->validate();
        Sizeoption::create($this->modelData());
    ...
    {
        $this->validate();
        Sizeoption::find($this->modelId)->update($this->modelData());
        $this->modalFormVisible = false;
    ...
    {
        Sizeoption::destroy($this->modelId);
    ...
    {
        return view('livewire.Sizeoptions', [
            'data' => $this->read(),
        ]);
    }
}
