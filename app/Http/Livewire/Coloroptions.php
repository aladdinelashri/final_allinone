...
class Coloroptions extends Component
{
    ...
    {
        $this->validate();
        Coloroption::create($this->modelData());
    ...
    {
        $this->validate();
        Coloroption::find($this->modelId)->update($this->modelData());
        $this->modalFormVisible = false;
    ...
    {
        $data = Coloroption::find($this->modelId);
        $this->name = $data->name;
        $this->note = $data->note;
    ...
    {
        return view('livewire.Coloroptions', [
            'data' => $this->read(),
        ]);
    }
}
